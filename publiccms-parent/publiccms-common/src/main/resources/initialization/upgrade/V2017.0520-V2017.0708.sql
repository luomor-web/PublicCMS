...
UPDATE `sys_moudle` SET name = '页面片段管理',attached = '<i class="icon-list-alt icon-large"></i>',`url` =  'cmsPlace/list',`authorized_url` =  'sysUser/lookup,cmsPlace/dataList',`menu` = 1,`parent_id` = 30,`sort` = 1 WHERE  `sys_moudle`.`id` =107;
